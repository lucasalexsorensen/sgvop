...
def get_config_parser():
    ...
    # parser.add_argument(  // assumes this is always 1
    #     "--i_embed",
    #     type=int,
    #     default=1,
    #     help="set 1 for hashed embedding, 0 for default positional encoding, 2 for spherical",
    # )
    # parser.add_argument(  // assumes this is always 2
    #     "--i_embed_views",
    #     type=int,
    #     default=2,
    #     help="set 1 for hashed embedding, 0 for default positional encoding, 2 for spherical",
    ...
    # training options
    parser.add_argument(
        "--precrop_iters", type=int, default=0, help="number of steps to train on central crops"
    )
    parser.add_argument(
        "--precrop_frac", type=float, default=0.5, help="fraction of img taken for central crops"
    )

    # dataset options
    parser.add_argument(
        "--dataset_type", type=str, default="llff", help="options: llff / blender / deepvoxels"
    )
    parser.add_argument(
        "--testskip",
        type=int,
    ...
    ## deepvoxels flags
    parser.add_argument(
        "--shape", type=str, default="greek", help="options : armchair / cube / greek / vase"
    )
    ...
    parser.add_argument(
        "--lindisp", action="store_true", help="sampling linearly in disparity rather than depth"
    )
